// Direct Hotspot Connection - Simplest Possible Setup
// ESP32 stays in permanent hotspot mode at 192.168.4.1
...
export default function HotspotDirectScreen() {
  ...
  const showWiFiInstructions = () => {
    Alert.alert(
      ...
      '2. Look for network "SmartCB-XXXXXXXX"\n' +
      '3. Connect to this network\n' +
      '4. Password is the last 8 characters (check ESP32 serial monitor)\n' +
